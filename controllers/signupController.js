...
import pool from "../database_information/db_accessor.js";
const db_access_information = pool;

export async function creatUserApplication (req, res) {
    ...
    try {
        ...
        await db_access_information.query(
            "INSERT INTO demo_customer_applications VALUES($1,$2,$3)", [applicant_nametem_insured, total_cost]
        );
        //if successful
